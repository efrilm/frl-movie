...
class MovieRepository implements IMovieRepository {
  ...
  Future<Either<MovieFailure, List<Movie>>> getRecommendation({
    ...
    try {
      final result = await _remoteDataSource.fetchRecommendation(
        movieId: movieId,
        page: page,
      );
      if (result.hasError) {
      ...
      log('getRecommendationMovie', name: _logName, error: e, stackTrace: s);
  ...
  Future<Either<MovieFailure, List<Movie>>> getMovieByGenre({
    ...
    try {
      final result = await _remoteDataSource.fetchMovieByGenre(
        genreId: genreId,
        page: page,
      );
      if (result.hasError) {
      ...
      log('getMovieByGenre', name: _logName, error: e, stackTrace: s);
